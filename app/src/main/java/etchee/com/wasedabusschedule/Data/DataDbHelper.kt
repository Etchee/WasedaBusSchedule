...
class DataDbHelper(context: Context, name: String, factory: SQLiteDatabase.CursorFactory?,
    ...
    override fun onCreate(db: SQLiteDatabase) {
        ...
        val CREATE_TO_WASEDA_TABLE:String =
                "CREATE TABLE IF NOT EXISTS " +
                to_wasedaDb.TABLE_NAME + " (" +
                to_wasedaDb._ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                to_wasedaDb.COLUMN_HOUR + " TEXT NOT NULL, " +
                to_wasedaDb.COLUMN_MIN + " TEXT NOT NULL, " +
                to_wasedaDb.COLUMN_SEARCH + " INTEGER NOT NULL, " +
                to_wasedaDb.COLUMN_FLAG + " INTEGER NOT NULL);"
...
//                        to_nishiDb._ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
        ...
        val CREATE_SAT_TO_WASEDA_TABLE:String = "CREATE TABLE IF NOT EXISTS " +
                ...
                sat_to_wasedaDb.COLUMN_HOUR + " TEXT NOT NULL, " +
                sat_to_wasedaDb.COLUMN_MIN + " TEXT NOT NULL, " +
                sat_to_wasedaDb.COLUMN_SEARCH + " INTEGER NOT NULL, "
        ...
        val CREATE_SAT_TO_NISHI_TABLE:String = "CREATE TABLE IF NOT EXISTS " +
                ...
                sat_to_nishiDb.COLUMN_HOUR + " TEXT NOT NULL, " +
                sat_to_nishiDb.COLUMN_MIN + " TEXT NOT NULL, " +
                sat_to_nishiDb.COLUMN_SEARCH + " INTEGER NOT NULL, " +
                sat_to_nishiDb.COLUMN_FLAG + " INTEGER NOT NULL);"

        //DEBUG
        val TEST:String = "CREATE TABLE IF NOT EXISTS " +
                sat_to_wasedaDb.TABLE_NAME + " (" +
                sat_to_wasedaDb._ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
